...
int main()
{
  ...
  // Try this if you implement a default constructor
  // Comparable<int> i0;
  // cout << "i0 = " << i0 << endl;
  ...
  /* The GNU g++ compiler does not support the alternate constructor syntax in the lines
   ...
   testComparable.cpp:155 : 27 : error : conversion from ëconst char[6]í to non - scalar type ëComparable<std::basic_string<char> >í requested
